...
const HOME_FAQS = [
  ...
  { q: 'How do I find the PIN code of my area?', a: "Use the search box above to type your area name, post office name, or 6-digit PIN code. You can also browse by state and district using the 'All States' section below." },
  { q: 'Are Indian PIN codes the same as ZIP codes?', a: "They serve the same purpose — identifying postal delivery areas — but PIN codes are specific to India's postal system, while ZIP codes are used in the United States. You can use a PIN code wherever a ZIP code is asked for Indian addresses." },
  { q: 'How do I write an Indian address for international shipping?', a: 'Write: [Recipient Name] / [Building, Street, Locality] / [City/Town] / [District, State — PIN CODE] / INDIA. Always include the 6-digit PIN code at the end to ensure correct delivery by India Post or international couriers.' },
];
            ...
            {indiaStates.map(s => {
              ...
              return (
                <Link key={s.slug} href={`/state/${s.slug}/`} className="province-card">
                  ...
                  {stat && (
                    <div className="province-card-range">{stat.offices.toLocaleString()} post offices</div>
                  )}
        ...
        <section className="section">
          ...
          <div className="steps-grid">
            ...
            <div className="step-card">
              ...
              <p className="step-desc">If you have a 6-digit PIN code and want to know which area it belongs to, type it in the search box.</p>
            </div>
          </div>
        </section>
